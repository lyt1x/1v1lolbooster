...
while True:
    with open("auth-token.txt",'r') as f:
        token = f.readline()
    try:
        url = "https://us-central1-justbuild-cdb86.cloudfunctions.net/player/updateProgressAndStats?gameMode=1v1_Competitive&isVictory=false&killsCount=0&deathsCount=1&isCompetitive=true&isBox=false"
